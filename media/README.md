...
These logos and symbols are provided for general use in discussion, documentation, research, and illustrative work (and maybe someday, on the side of spaceships). Feel free to use them.

They are not trademarks, and there is no requirement to use them. You are welcome to adapt or reinterpret them in ways that align with the ideas of Open Space Federation.

### Other Logo Designs

![Open Space Federation](open-space-logo.png)
